...
function renderReportHtml_(verse) {
  ...
  return `<!DOCTYPE html><html><head><meta charset="UTF-8"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">${style}</head><body><div class="wrap"><h2>Стих за деня</h2><p class="text">"${v.text}"</p><p class="ref">${refHtml}</p><div class="note">Избран на база топ ${CFG.newsCount} новини от България.</div><div class="unsubscribe">Не искаш повече да получаваш тези имейли? <a href="YOUR_LANDING_PAGE_URL" target="_blank">Отпиши се тук</a></div></div></body></html>`;
}
