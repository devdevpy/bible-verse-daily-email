...
ВАЖНО: 
- Избери ПО-МАЛКО познат стих (не Йоан 3:16, Псалм 23:1, Филипяни 4:13)
- Опитай се да намериш стих от различна книга от Библията
- Всеки път избирай различен стих според конкретния контекст на новините
- Предпочитай стихове от по-малко известни книги
...
`;
  ...
  const payload = {
    ...
    temperature: 0.95,  // Увеличена креативност за повече разнообразие
